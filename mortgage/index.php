  ...
  <div class="list-section">
    <div class="container">
      ...
      <div class="list-section-frame">
        <ol class="list">
          <li class="list-item">Состав услуги</li>
          <li class="list-item">Состав услуги</li>
          <li class="list-item">Состав услуги</li>
          <li class="list-item">Состав услуги</li>
          <li class="list-item">Состав услуги</li>
    ...
    <div class="container">
      ...
      <div class="list-section-frame">
        <ul class="list">
          ...
          <li class="list-item">Справка</li>
          <li class="list-item">Трудовая книжка</li>
          <li class="list-item">Документы, подтверждающие доходы: 2НДФЛ или справка по форме банка</li>
        </ul>
      </div>
      <div class="horizontal-line"></div>
    </div>
      ...
      <div class="accordeon">
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Какие документы необходимы для подачи заявки на ипотеку?</div>
            <div class="arrow"></div>
          </div>
        ...
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Как я могу подать заявку на ипотеку?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Можно написать текст онлайн на русском языке нейросетью. Генератор текста онлайн бесплатно экономит время и силы с искусственным интеллектом.</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Есть стабильный доход, но официально не трудоустроен, смогу ли получить одобрение?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Да, оформить заявку Вы можете по двум документам (Паспорт и СНИЛС), в анкете необходимо будет указать сведения о работодателе и доходе, так же допускается указать реквизиты ИП.</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Смогу ли я продать ипотечную недвижимость?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Можно написать текст онлайн на русском языке нейросетью. Генератор текста онлайн бесплатно экономит время и силы с искусственным интеллектом.</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Какой минимальный первоначальный взнос должен быть при покупке в ипотеку?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Можно написать текст онлайн на русском языке нейросетью. Генератор текста онлайн бесплатно экономит время и силы с искусственным интеллектом.</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Возможно ли оформить ипотечную сделку дистанционно?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Можно написать текст онлайн на русском языке нейросетью. Генератор текста онлайн бесплатно экономит время и силы с искусственным интеллектом.</div>
        </div>
