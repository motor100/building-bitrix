...
<div class="mortgage-page">
  ...
  <div class="container">
    <div class="primary-title page-title">Ипотека</div>
  </div>

  <div class="submit-application-section">
    <div class="container">
      <div class="submit-application-section-title primary-title mortgage-page-section-title">Подайте заявку на ипотеку через ЭРИСТАВИ</div>
      <div class="submit-application-section-text">Мы берем на себя контроль ипотечных предложений! Наш отдел постоянно отслеживает актуальные программы и акции банков, чтобы предлагать покупателям максимально выгодные условия и оптимальные решения по финансированию, минимизировать ваши затраты, а значит сделать покупку квартиры максимально комфортной и выгодной. Мы заботимся о том, чтобы была возможность получить персональное предложение и лучшие условия кредитования.</div>
      <div class="flex-container">
        <div class="submit-application-item submit-application-item-blue">
          <div class="submit-application-item__title">96% одобрений</div>
          <div class="submit-application-item__text">высокая вероятность получить ипотеку</div>
        </div>
        <div class="submit-application-item submit-application-item-lightgrey">
          <div class="submit-application-item__title">>800 тыс. онлайн-анкет</div>
          <div class="submit-application-item__text">ипотека без визитов в банк</div>
        </div>
        <div class="submit-application-item submit-application-item-lightgrey">
          <div class="submit-application-item__title">28 банков-партнёров</div>
          <div class="submit-application-item__text">подберём лучшие условия для вас</div>
        </div>
      </div>
      <button class="submit-application-btn primary-btn">
        <span class="primary-btn__text">Подать заявку на ипотеку</span>
      </button>
  ...
  <div class="list-section">
    <div class="container">
      <div class="list-section__title">Что вы получите от ипотечного специалиста при оформлении сделки</div>
      <div class="list-section-frame">
        <ol class="list">
          <li class="list-item">Персональная консультация по ипотеке:<br>
            Анализ вашей текущей финансовой ситуации.<br>
            Ответы на все вопросы до подачи ипотечной заявки, чтобы вы были уверены в каждом шаге.<br>
          </li>
          <li class="list-item">
            Формирование пакета документов:<br>
            Помощь в сборе и формировании правильного пакета документов, соответствующего требованиям банков для подачи заявки.
            Анализ кредитной истории и кредитной нагрузки.<br>
            Помощь в корректировке кредитной нагрузки, выявление и устранение незаметных задолженностей.<br>
            Быстрая и корректная подача ипотечных заявок.
          </li>
          <li class="list-item">
            Взаимодействие с банками на всех этапах:<br>
            Оперативное предоставление дополнительных документов.
          </li>
          <li class="list-item">
            Подготовка документов на одобрение объекта недвижимости:<br>
            Составление и корректировка договора долевого участия (ДДУ) в соответствии с требованиями конкретного банка, сопровождение согласования объекта с банком.<br>
            Подбор выгодных страховых программ с партнерскими скидками.<br>
            Согласование с банком отказа от ненужных дополнительных продуктов, чтобы минимизировать ваши затраты.<br>
            Запись на удобное для вас время в банк для подписания документов.<br>
            Координация действий между банком, застройщиком и вами.<br>
            Контроль корректности оформления и подписания кредитной документации.<br>
            Помощь и поддержка до успешного завершения ипотечной сделки.
          </li>
        </ol>
      </div>
      <div class="horizontal-line"></div>
  ...
  <div class="list-section">
    <div class="container">
      <div class="list-section__title">Перечень стандартных документов, необходимых для оформления ипотеки</div>
      <div class="list-section-frame">
        <ul class="list">
          <li class="list-item">Паспорт</li>
          <li class="list-item">СНИЛС</li>
          <li class="list-item">ИНН</li>
          <li class="list-item">Свидетельство о заключении/расторжении брака/брачный договор</li>
          <li class="list-item">Свидетельства о рождении детей</li>
          <li class="list-item">Номер телефона</li>
          <li class="list-item">Электронная почта</li>
          <li class="list-item">Трудовая книжка</li>
          <li class="list-item">Справки 2-НДФЛ за текущий и предыдущий годы</li>
          <li class="list-item">Свидетельство материнского семейного капитала и актуальный остаток материнского семейного капитала</li>
        </ul>
      </div>
      <div class="horizontal-line"></div>
    </div>
  ...
  <div class="accordeon-section section">
    <div class="container">
      <div class="accordeon-section-title primary-title mortgage-page-section-title">Вопросы и ответы</div>
      <div class="accordeon">
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Могу ли я взять ипотеку если у меня есть действующие кредиты?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Да, все зависит от Вашего дохода и действующей нагрузки (количества иждивенцев, текущие расходы).</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Могу ли я взять льготную ипотеку, если у меня есть действующая льготная ипотека?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Да при условии если предыдущая льготная ипотека взята до 23.12.2023 г.</div>
        </div>
        <div class="accordeon-item">
          <div class="title-wrapper">
            <div class="accordeon-item-title">Могу ли я взять Семейную ипотеку если я не состою в браке?</div>
            <div class="arrow"></div>
          </div>
          <div class="accordeon-text">Да право на Семейную ипотеку Вам дают дети, подходящие по возрасту или статусу (для г. Южноуральск либо 1 ребенок не достигший 7 лет, либо 2-е несовершеннолетних детей, либо один несовершеннолетний  ребенок-инвалид).</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="contacts-section">
    <div class="container">
      <div class="flex-container">
        <div class="contacts-item contacts-item-lightgrey">
          <div class="contacts-item__title">У вас еще остались вопросы?<br>Воспользуйтесь онлайн-консультацией</div>
          <div class="socials">
        ...
        <div class="contacts-item contacts-item-blue">
          <div class="contacts-item__title">Хотите знать больше про ипотеку?<br>Используйте наш Гид по ипотеке</div>
          <div class="contacts-item__text">Разбираемся в тонкостях сделки</div>
          <a href="/mortgage-guide" class="view-more-btn tertiary-btn">
            <span class="tertiary-btn__text">Узнать больше</span>
          </a>
        </div>
      </div>
    </div>
