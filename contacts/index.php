...
<div class="contacts-page">
  ...
  <div id="big-booking-online-form-wrapper" class="booking-online-form-wrapper big-booking-online-form-wrapper section">
    <div class="container">
...
<div id="write-us-modal" class="modal-window write-us-modal">
  <div class="modal-wrapper">
    <div class="modal-area">
      ...
      <form id="write-us-modal-form" class="form" method="post">
        <div class="form-group">
          <label for="name-write-us-modal" class="label">Имя*</label>
          <input type="text" id="name-write-us-modal" class="input-field js-required-name" name="name" required autocomplete="on" minlength="3" maxlength="50" autocomplete="on">
        </div>
        <div class="form-group">
          <label for="email-write-us-modal" class="label">Email*</label>
          <input type="email" id="email-write-us-modal" class="input-field js-required-email" name="email" required autocomplete="on" minlength="3" maxlength="50" autocomplete="on">
        </div>
        <div class="form-group">
          <label for="message-write-us-modal" class="label">Сообщение*</label>
          <textarea type="message" id="message-write-us-modal" class="input-field textarea js-required-message" name="message" required minlength="3" maxlength="300" autocomplete="off"></textarea>
        </div>
        <button type="button" id="write-us-modal-btn" class="submit-btn primary-btn">
          <span class="primary-btn__text">Отправить</span>
        </button>
        <div class="agreement-text">
            <input type="checkbox" name="checkbox-read" class="custom-checkbox js-required-checkbox" id="checkbox-read-write-us" required onchange="document.getElementById('write-us-modal-btn').disabled = !this.checked;">
            <label for="checkbox-read-write-us" class="custom-checkbox-label"></label>
          ...
          <div class="agreement-text">
            <input type="checkbox" name="checkbox-agree" class="custom-checkbox js-required-checkbox" id="checkbox-agree-write-us" required onchange="document.getElementById('write-us-modal-btn').disabled = !this.checked;">
            <label for="checkbox-agree-write-us" class="custom-checkbox-label"></label>
