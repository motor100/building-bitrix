    ...
    <div class="modal-area">
      ...
      <form id="write-us-modal-form" class="form" method="post">
        ...
        <div class="form-group">
          ...
          <textarea type="message" id="message-write-us-modal" class="input-field textarea js-required-message" name="message" required minlength="3" maxlength="300" autocomplete="on"></textarea>
        </div>
